...
public class RegisterView {
        ...
        private StackPane createLeftMarketingPanel() {
                ...
                ImageView logoIcon = createSafeImageView(
                                "/images/logo.png",
                                45,
                                45);

                Node logoGraphic = logoIcon.getImage() != null
                                ? logoIcon
                ...
                cardContainer.getChildren().addAll(
                                createFeatureCard(
                                                ...
                                                "End-to-end encrypted medical data complying with global privacy standards."),

                                createFeatureCard(
                                                "🤖 AI-Powered Medical Insights",
                                                "Automated clinical triage, decision assistance, and predictive diagnostics."),

                                createFeatureCard(
                                                "🛡️ Trusted by Patients",
                                                "Over 100,000+ verified appointments and records delivered seamlessly."));
        ...
        private ScrollPane createRightRegistrationPanel() {
                ...
                outerWrapper.setPadding(
                                new Insets(32, 24, 32, 24));

                VBox mainCard = new VBox(20);

                mainCard.getStyleClass().add(
                                "main-white-card");
                ...
                ImageView centeredLogo = createSafeImageView(
                                "/images/logo.png",
                                52,
                                52);

                Node logoGraphic = centeredLogo.getImage() != null
                                ? centeredLogo
                                : createFallbackLogoGraphic();
                ...
                headingText.getStyleClass().add(
                                "heading-text");

                subtitleText = new Text(
                                "Join the future of smart healthcare management");

                subtitleText.getStyleClass().add(
                                "subtitle-text");

                textHeader.getChildren().addAll(
                                headingText,
                                subtitleText);
                ...
                stepIndicatorContainer.setPadding(
                                new Insets(4, 0, 8, 0));
                ...
                formContentContainer.getChildren().setAll(
                                createStep1Pane());
        ...
        private boolean validateRoleInformation() {
                ...
                switch (selectedRole) {
                        ...
                        case "Patient":
                                ...
                                if (patientDobField.getValue() == null) {
                                        ...
                                        patientDobField.requestFocus();

                                        return false;
                                }

                                if (patientGenderField.getValue() == null) {

                                        showValidationError(
                                                        "Gender is required.");

                                        patientGenderField.requestFocus();

                                        return false;
                                }

                                if (patientBloodGroupField.getValue() == null) {

                                        showValidationError(
                                                        "Blood Group is required.");

                                        patientBloodGroupField.requestFocus();

                                        return false;
                                }

                                if (patientEmergencyContactField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        patientEmergencyContactField.requestFocus();

                                        return false;
                                }

                                if (patientAddressField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        patientAddressField.requestFocus();
                        ...
                        case "Doctor":
                                ...
                                if (doctorLicenseField
                                        ...
                                        doctorLicenseField.requestFocus();

                                        return false;
                                }

                                if (doctorSpecializationField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        doctorSpecializationField.requestFocus();

                                        return false;
                                }

                                if (doctorQualificationField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        doctorQualificationField.requestFocus();

                                        return false;
                                }

                                if (doctorExperienceField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        doctorExperienceField.requestFocus();
                        ...
                        case "Hospital":
                                ...
                                if (hospitalNameField
                                        ...
                                        hospitalNameField.requestFocus();

                                        return false;
                                }

                                if (hospitalRegistrationField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        hospitalRegistrationField.requestFocus();

                                        return false;
                                }

                                if (hospitalTypeField.getValue() == null) {

                                        showValidationError(
                                                        "Hospital Type is required.");

                                        hospitalTypeField.requestFocus();

                                        return false;
                                }

                                if (hospitalBedsField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        hospitalBedsField.requestFocus();
                                ...
                                if (hospitalContactField
                                        ...
                                        hospitalContactField.requestFocus();

                                        return false;
                                }

                                if (hospitalAddressField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        hospitalAddressField.requestFocus();
                        ...
                        case "Administrator":
                                ...
                                if (adminInvitationCodeField
                                        ...
                                        adminInvitationCodeField.requestFocus();

                                        return false;
                                }

                                if (adminDepartmentField
                                                .getText()
                                                .trim()
                                                .isEmpty()) {
                                        ...
                                        adminDepartmentField.requestFocus();
                                ...
                                switch (selectedRole) {
                                        ...
                                        case "Doctor":
                                                ...
                                                doctorRegistrationController.register(
                                                                ...
                                                                passwordField.getText(),
                                                                phoneField.getText().trim(),
                                                                doctorLicenseField.getText().trim(),
                                                                doctorSpecializationField.getText().trim(),
                                                                doctorExperienceField.getText().trim(),
                                                                doctorQualificationField.getText().trim(),
                                                                doctorFeeField.getText().trim());
                                        ...
                                        case "Hospital":
                                                ...
                                                hospitalRegistrationController.register(
                                                                ...
                                                                hospitalRegistrationField.getText().trim(),
                                                                hospitalTypeField.getValue(),
                                                                hospitalBedsField.getText().trim(),
                                                                hospitalContactField.getText().trim(),
                                                                hospitalAddressField.getText().trim());
        ...
        private void renderCurrentStepView() {
                ...
                switch (currentStep) {
                        ...
                        case 2:
                                ...
                                /*
                                 * Prevent JavaFX from automatically placing
                                 * the keyboard focus on the first TextField.
                                 *
                                 * This does NOT affect validation.
                                 * Validation can still call requestFocus()
                                 * when a required field is missing.
                                 */
                                formContentContainer.setFocusTraversable(true);

                                Platform.runLater(() -> formContentContainer.requestFocus());
                        ...
                        case 3:
                                ...
                                headingText.setText(
                                                selectedRole + " Information");

                                subtitleText.setText(
                                                "Enter role-specific credentials for onboarding");
                        ...
                        case 4:
                                ...
                                subtitleText.setText(
                                                "Your account status and next steps");
        ...
        private VBox createStep1Pane() {
                ...
                VBox patientCard = createRoleCard(
                                "/images/patient.png",
                                "👤",
                                "Patient",
                                "Book appointments • Access reports • AI Assistant",
                                false,
                                "Instant Access",
                                "badge-instant-access");

                VBox doctorCard = createRoleCard(
                                "/images/doctor.png",
                                "🩺",
                                "Doctor",
                                "Medical License Required • Professional Verification",
                                false,
                                "Verification Required",
                                "badge-verification-required");

                VBox hospitalCard = createRoleCard(
                                "/images/hospital.png",
                                "🏥",
                                "Hospital",
                                "Organization Registration • Admin Approval Required",
                                false,
                                "Approval Required",
                                "badge-verification-required");
                ...
                VBox adminCard = createRoleCard(
                                ...
                                "🛡️",
                                "Administrator",
                                "System controls • Audit logs • User governance",
                                true,
                                "Invite Only",
                                "badge-invite-only");
                ...
                if (selectedRole.equalsIgnoreCase("Doctor")) {
                        ...
                        currentlySelectedRoleCard = doctorCard;

                } else if (selectedRole.equalsIgnoreCase("Hospital")) {

                        currentlySelectedRoleCard = hospitalCard;

                } else if (selectedRole.equalsIgnoreCase("Administrator")) {

                        currentlySelectedRoleCard = adminCard;

                } else {

                        currentlySelectedRoleCard = patientCard;
                }

                currentlySelectedRoleCard
                                .getStyleClass()
                                .add(
                                                "role-card-selected");
                ...
                bottomControls.setAlignment(
                                Pos.CENTER_RIGHT);

                HBox loginPromptBox = new HBox(4);

                loginPromptBox.setAlignment(
                                Pos.CENTER_LEFT);

                Text promptText = new Text(
                                "Already have an account? ");

                promptText.getStyleClass().add(
                                "login-prompt-text");

                Text loginLink = new Text(
                                "Log In");

                loginLink.getStyleClass().add(
                                "login-link-text");
                ...
                loginPromptBox.getChildren().addAll(
                                promptText,
                                loginLink);
        ...
        private VBox createRoleCard(
                ...
                ImageView iconView = createSafeImageView(
                                iconPath,
                                24,
                                24);

                Node iconNode = iconView.getImage() != null
                                ? iconView
        ...
        private void addCardHoverAndSelection(
                        VBox card,
                        String roleName) {
        ...
        private VBox createPatientRoleInfo() {
                ...
                patientGenderField.setPromptText(
                                "Select gender");
                ...
                patientBloodGroupField.setPromptText(
                                "Select blood group");

                patientBloodGroupField
                                .getStyleClass()
                                .add(
                                                "text-field-custom");

                patientEmergencyContactField.setPromptText(
                                "+91 9876543210");

                patientEmergencyContactField
                                .getStyleClass()
                                .add(
                                                "text-field-custom");

                patientAddressField.setPromptText(
                                "Enter your address");
        ...
        private VBox createAdminRoleInfo() {
                ...
                adminInvitationCodeField.setPromptText(
                                "Enter admin invite code");

                adminInvitationCodeField
                                .getStyleClass()
                                .add(
                                                "text-field-custom");

                adminDepartmentField.setPromptText(
                                "e.g. IT Operations");

                adminDepartmentField
                                .getStyleClass()
                                .add(
                                                "text-field-custom");

                adminIdField.setPromptText(
                                "Employee ID");
        ...
        private VBox createRoleInfoHeading(
                        String titleText,
                        String subtitleText) {
        ...
        private VBox createFieldWrapper(
                        String labelText,
                        Node field) {
        ...
        private void addBtnAnimations(
                ...
                ScaleTransition stIn = new ScaleTransition(
                                Duration.millis(100),
                                btn);
                ...
                ScaleTransition stOut = new ScaleTransition(
                                Duration.millis(100),
                                btn);
                ...
                btn.setOnMouseEntered(
                                e -> stIn.playFromStart());

                btn.setOnMouseExited(
                                e -> stOut.playFromStart());
        }
        ...
        private HBox createFooter() {
                ...
                Text copyright = new Text(
                                "© 2026 Health-Sphere AI. All rights reserved.");

                copyright.getStyleClass().add(
                                "footer-text");
